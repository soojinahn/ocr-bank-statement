...
#This ensures Django searches for templates and static files in frontend folder, outside of Django directory
...
SECRET_KEY = 'django-insecure-)dd#egd8+83^ya5vzm=9biy9=39u=s9#mc7t2w)w*qnhul=2q!'
...
MEDIA_ROOT = os.path.join(REAL_BASE_DIR, 'frontend', 'build', 'uploads')
MEDIA_URL = '/media/'
